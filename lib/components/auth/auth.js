...
/*
This app uses `Implicit Grant Flow` auth method to retrieve token from Spotify Account Service. these are temporary tokens which are valid for 1 hour.
more info at https://developer.spotify.com/documentation/general/guides/authorization-guide/#implicit-grant-flow
*/
		...
		<>
			...
			<footer className={styles.footer}>
				<p className={styles.footerCaption}>
					...
					&nbsp;<a href='https://github.com/faraadi/yasna-challenge2/blob/master/LICENSE' className={styles.footerLink}>MIT</a>&nbsp;
					also. so you can read our
					&nbsp;<a href='https://github.com/faraadi/yasna-challenge2' className={styles.footerLink}>Source Code</a>&nbsp;
					as well.
				</p>
			</footer>
			<style jsx global>
